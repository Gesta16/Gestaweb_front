...
const routes:Routes = [
  {
    ...
    children: [
      ...
      {path: 'ruta-4/:id/:num_proceso', component:Ruta4Component, data: { title: 'Dashboard', icon: 'fa-solid fa-chart-pie', showInMenu: true }},
      {path: 'ruta-5', component:Ruta5Component, data: { title: 'Dashboard', icon: 'fa-solid fa-chart-pie', showInMenu: true }},
      {path: 'ruta-5/:id/:num_proceso', component:Ruta5Component, data: { title: 'Dashboard', icon: 'fa-solid fa-chart-pie', showInMenu: true }},
      {path: 'ruta-6', component:Ruta6Component, data: { title: 'Dashboard', icon: 'fa-solid fa-chart-pie', showInMenu: true }},
      {path: 'ruta-6/:id/:num_proceso', component:Ruta6Component, data: { title: 'Dashboard', icon: 'fa-solid fa-chart-pie', showInMenu: true }},
